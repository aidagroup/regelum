...
| Fig. 9 DC bus | around 350 V | 343.3-350.2 V |
| Fig. 11 dump load turns on | 6.65 s | 6.65 s |
| Calibrated Fig. 9 battery capacity | fit parameter | 75.5 kWh |
| Calibrated Fig. 11 initial SOC | fit parameter | 99.743 % |
| Fig. 9 battery_current_a RMSE | digitized paper output | 33.68 |
| Fig. 9 wind_current_a RMSE | digitized paper output | 0.006656 |
| Fig. 9 load_voltage_magnitude_v RMSE | digitized paper output | 0.6958 |
| Fig. 9 soc_percent RMSE | digitized paper output | 0.01231 |
| Fig. 9 dc_bus_voltage_v RMSE | digitized paper output | 1.278 |
| Fig. 9 frequency_hz RMSE | digitized paper output | 0.02349 |
